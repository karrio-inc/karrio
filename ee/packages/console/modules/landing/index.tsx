        ...
        <div className="container mx-auto px-4 relative max-w-[95%] xl:max-w-[1280px]">
          <div className="mb-16">
            ...
            <p className="text-white/60 max-w-3xl">
              From marketplaces to enterprise logistics, Karrio provides specialized solutions to meet the unique requirements of different business models and industries.
            </p>
          </div>
          <div className="space-y-12">
            <FeatureShowcase
              title="Marketplace & OMS"
            ...
            />
            <FeatureShowcase
              title="Logistics Providers & Carriers"
              description="Build stronger partnerships and expand your network with our comprehensive logistics solutions designed for carriers and 3PLs."
              learnMoreHref="#"
              tabs={[
                {
                  label: "Overview",
                  ...
                  content: (
                    <div className="grid lg:grid-cols-2 gap-8">
                      ...
                      <div className="bg-black/20 aspect-video rounded-lg overflow-hidden">
                        <Image
                          src="/logistics-illustration.svg"
                          width={800}
                          height={400}
